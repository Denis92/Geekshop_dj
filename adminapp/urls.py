...
urlpatterns = [
    ...
    path('categories/create/', adminapp.CatigoriesCreateView.as_view(), name='category_create'),
    path('categories/read/', adminapp.CategoriesListView.as_view(), name='categories'),
    path('categories/update/<int:pk>/', adminapp.CatigoriesUpdateView.as_view(), name='category_update'),
    path('categories/delete/<int:pk>/', adminapp.CatigoriesDeleteView.as_view(), name='category_delete'),

    path('products/create/category/', adminapp.ProductCreateView.as_view(), name='product_create'),
